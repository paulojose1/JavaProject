 ...
 * @author paulo
 */
public class JRegisterForm extends javax.swing.JFrame {

    /**
     * Creates new form JRegisterForm
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JRegisterForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JRegisterForm().setVisible(true);
            }
        });
    }
