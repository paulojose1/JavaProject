 ...
 * @author paulo
 */
public class JFacultyMenu extends javax.swing.JFrame {

    /**
     * Creates new form JFacultyMenu
     */
    public JFacultyMenu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFacultyMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFacultyMenu().setVisible(true);
            }
        });
    }
