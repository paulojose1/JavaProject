 ...
 * @author paulo
 */
public class JSuperAdminMenu extends javax.swing.JFrame {

    /**
     * Creates new form JSuperAdminMenu
     */
    public JSuperAdminMenu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JSuperAdminMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JSuperAdminMenu().setVisible(true);
            }
        });
    }
